...
public class RtpCommand extends DecoreModElements.ModElement {
	public RtpCommand(DecoreModElements instance) {
		super(instance, 2);
	}
	...
	private LiteralArgumentBuilder<CommandSource> customCommand() {
		return LiteralArgumentBuilder.<CommandSource>literal("rtp").requires(s -> s.hasPermissionLevel(1))
