...
public class TeleportWandItem extends DecoreModElements.ModElement {
	@ObjectHolder("decore:teleport_wand")
	public static final Item block = null;
	public TeleportWandItem(DecoreModElements instance) {
		super(instance, 14);
	}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Teleport Wand");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new TeletportWandGUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
